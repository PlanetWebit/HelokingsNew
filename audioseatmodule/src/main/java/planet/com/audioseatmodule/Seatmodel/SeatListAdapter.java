...
import planet.com.audioseatmodule.R;
import planet.com.audioseatmodule.RetrofitAPI.RetrofitClient;
...
public class SeatListAdapter extends RecyclerView.Adapter<SeatListAdapter.SeatListHolder> {
    ...
    public SeatListAdapter(String authtoken, String roomid, String useridd, Activity context) {
    ...
    public void onBindViewHolder(@NonNull SeatListHolder holder, int position) {
        ...
        holder.seatCount.setText("No. "+(position+1));
...
//                } else {
//                    holder.lSeat.setVisibility(View.INVISIBLE);
...
//        Toast.makeText(context,"Image",Toast.LENGTH_LONG).show();
         Call<ResponseOtherData> moduleCall = RetrofitClient.getInstance().getAllApiResponse().getOtherUserData(authtoken,seatModel.iid,roomid);
