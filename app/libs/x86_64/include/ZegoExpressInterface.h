...
class IZegoRangeSceneStream {
  ...
  public:
    ...
    /// Use case: After receiving from the [onuserstreamstateupdate] callback that the SDK automatically plays other user streams within the scope successfully, the user can call this function to update canvas display video.
    /// When to call: After receiving from the [onuserstreamstateupdate] callback that the SDK automatically plays other user streams within the scope successfully.
    /// Restrictions: None.
    /// Caution: None.
    /// Note: This function is only available in ZegoExpressVideo SDK!
    ///
