...
class ZegoExpressEngineBridge {
  ...
  public:
    ...
    int isVideoEncoderSupported(zego_video_codec_id codecID,
        ...
        return zego_express_is_video_encoder_supported(codecID, codecBackend);
    }
    ...
    int isVideoDecoderSupported(zego_video_codec_id codecID,
        ...
        return zego_express_is_video_decoder_supported(codecID, codec_backend);
    }
    ...
    void enableVideoSuperResolution(const std::string &streamID, bool enable) {
        zego_express_enable_video_super_resolution(streamID.c_str(), enable);
    }
    ...
    int copyrightedMusicRequestResource(zego_copyrighted_music_request_config config,
        ...
        int seq = zego_express_copyrighted_music_request_resource(config, type);
        return seq;
    }

    int copyrightedMusicGetSharedResource(zego_copyrighted_music_get_shared_config config,
                                          zego_copyrighted_music_resource_type type) {
        int seq = zego_express_copyrighted_music_get_shared_resource(config, type);
        return seq;
    }
    ...
    int copyrightedMusicGetFullScore(const char *resource_id) {
        int ret = zego_express_copyrighted_music_get_full_score(resource_id);
        return ret;
    }
    ...
    void freeScreenCaptureSourceList(struct zego_screen_capture_source_info *list,
                                     int source_count) {
    ...
    int createRangeScene() {
        int range_scene_handle = zego_express_create_range_scene();
    ...
    int updatePlayingCanvas(int range_scene_handle, const char *stream_id, zego_canvas *canvas) {
        return zego_express_range_scene_stream_update_playing_canvas(range_scene_handle, stream_id,
                                                                     canvas);
    }
