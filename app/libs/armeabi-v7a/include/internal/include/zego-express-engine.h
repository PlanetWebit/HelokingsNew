...
ZEGOEXP_API void EXP_CALL zego_express_set_local_proxy_config(
...
/// @param token token.
/// @param enable enable proxy or not.
ZEGOEXP_API void EXP_CALL zego_express_set_cloud_proxy_config(
...
ZEGOEXP_API void EXP_CALL zego_express_is_feature_supported(enum zego_feature_type feature_type,
                                                            bool *is_supported);
...
ZEGOEXP_API void EXP_CALL zego_express_set_room_scenario(enum zego_scenario scenario);
