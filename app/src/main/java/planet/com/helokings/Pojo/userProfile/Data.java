...
public class Data {
	...
	public void setText_buble(String text_buble) {
		this.text_buble = text_buble;
	}

	public String getWall_papers() {
		return wall_papers;
	}

	public void setWall_papers(String wall_papers) {
		this.wall_papers = wall_papers;
	}
