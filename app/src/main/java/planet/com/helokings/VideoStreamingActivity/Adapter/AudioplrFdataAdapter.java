...
public class AudioplrFdataAdapter extends RecyclerView.Adapter<AudioplrFdataAdapter.ViewHolder> {
    Activity context;

    List<DataItem> data;


    public AudioplrFdataAdapter(Activity context, List<DataItem> data) {
